...
namespace AgencyTemplate.Areas.Control.Controllers
{
    public class AboutsController : Controller
    {
        ...
        // GET: Control/Abouts/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Control/Abouts/Create
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Description,StartDate,EndDate,Photo,Status")] About about)
        {
            if (ModelState.IsValid)
            {
